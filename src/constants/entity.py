...
class DataTransformationEntity(ArtifactEntity):
    def __init__(self):
        ...
        self.DROP_COLUMNS: list = ['id', 'name', 'close_approach_date', 'close_approach_date_full', 
                                   'nasa_jpl_url', 'orbiting_body', 'max_diameter_km', 'min_diameter_km']
       ...
       'relative_velocity_kps', 'miss_distance_km', 'is_sentry_object','diameter_range']
        ...
        self.NUMERICAL_COLUMNS: list = ['absolute_magnitude_h', 'epoch_date_close_approach', 
                                        'relative_velocity_kps','miss_distance_km', 'diameter_range']
