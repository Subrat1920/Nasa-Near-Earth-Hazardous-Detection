            ...
            for date, asteroids in data["near_earth_objects"].items():
                for asteroid in asteroids:
                    neo_list.append({
                        ...
                        "min_diameter_m": asteroid.get("estimated_diameter", {}).get("meters", {}).get("estimated_diameter_min"),
                        "max_diameter_m": asteroid.get("estimated_diameter", {}).get("meters", {}).get("estimated_diameter_max"),
                        "close_approach_date": asteroid.get("close_approach_data", [{}])[0].get("close_approach_date"),
                        "epoch_date_close_approach": asteroid.get("close_approach_data", [{}])[0].get("epoch_date_close_approach"),
                        "miss_distance_km": asteroid.get("close_approach_data", [{}])[0].get("miss_distance", {}).get("kilometers"),
                        "relative_velocity_kph": asteroid.get("close_approach_data", [{}])[0].get("relative_velocity", {}).get("kilometers_per_hour"),
